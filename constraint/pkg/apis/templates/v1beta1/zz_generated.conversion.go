...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Code)(nil), (*templates.Code)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_Code_To_templates_Code(a.(*Code), b.(*templates.Code), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*templates.Code)(nil), (*Code)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_templates_Code_To_v1beta1_Code(a.(*templates.Code), b.(*Code), scope)
	}); err != nil {
		return err
	}
...
func Convert_v1beta1_Code_To_templates_Code(in *Code, out *templates.Code, s conversion.Scope) error {
	return autoConvert_v1beta1_Code_To_templates_Code(in, out, s)
}
...
func Convert_templates_Code_To_v1beta1_Code(in *templates.Code, out *Code, s conversion.Scope) error {
	return autoConvert_templates_Code_To_v1beta1_Code(in, out, s)
}
...
func autoConvert_v1beta1_ConstraintTemplateSpec_To_templates_ConstraintTemplateSpec(in *ConstraintTemplateSpec, out *templates.ConstraintTemplateSpec, s conversion.Scope) error {
	...
	if in.Targets != nil {
		...
		*out = make([]templates.Target, len(*in))
		for i := range *in {
			if err := Convert_v1beta1_Target_To_templates_Target(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_templates_ConstraintTemplateSpec_To_v1beta1_ConstraintTemplateSpec(in *templates.ConstraintTemplateSpec, out *ConstraintTemplateSpec, s conversion.Scope) error {
	...
	if in.Targets != nil {
		...
		*out = make([]Target, len(*in))
		for i := range *in {
			if err := Convert_templates_Target_To_v1beta1_Target(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_templates_Target_To_v1beta1_Target is manually defined in conversion.go to handle Operation field
