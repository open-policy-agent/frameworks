...
// Convert_v1beta1_Validation_To_templates_Validation is an autogenerated conversion function.
func Convert_v1beta1_Validation_To_templates_Validation(in *Validation, out *templates.Validation, s conversion.Scope) error {
	return autoConvert_v1beta1_Validation_To_templates_Validation(in, out, s)
}
...
func autoConvert_templates_Validation_To_v1beta1_Validation(in *templates.Validation, out *Validation, s conversion.Scope) error {
	if in.OpenAPIV3Schema != nil {
		...
		*out = new(apiextensionsv1beta1.JSONSchemaProps)
		// FIXME: Provide conversion function to convert apiextensions.JSONSchemaProps to apiextensionsv1beta1.JSONSchemaProps
		compileErrorOnMissingConversion()
	} else {
		out.OpenAPIV3Schema = nil
	}
